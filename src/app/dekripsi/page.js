...
export default function Home() {
  ...
  const encryptCaesarCipher = () => {
    ...
    const result = Array.from(ciphertext).map((char) => {
      ...
      if (char >= "a" && char <= "z") {
        ...
        // Apply encryption formula for uppercase letters based on the specified direction
        if (direction === "right") {
          ...
          <div class="container px-5 pt-10 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
              ...
              <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
                Silahkan masukkan teks yang ingin didekripsi beserta key Caesar
                Cipher yang diketahui. Setelah itu, tekan tombol "DEKRIPSI"
                untuk mendapatkan hasil dari dekripsi teks tersebut.
              </p>
            </div>
